...
public interface CfgAuditMapper {
    ...
    @Insert({
        ...
        "status, applicant_aid, ",
        "reviewer_aid, submit_time, ",
        "handle_time)",
        "values (#{id,jdbcType=INTEGER}, #{cfgCollectionId,jdbcType=INTEGER}, ",
        "#{status,jdbcType=INTEGER}, #{applicantAid,jdbcType=INTEGER}, ",
        "#{reviewerAid,jdbcType=INTEGER}, #{submitTime,jdbcType=BIGINT}, ",
    ...
    @Select({
        "select",
        "id, cfg_collection_id, status, applicant_aid, reviewer_aid, submit_time, handle_time",
        "from cfg_audit",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
