...
import org.zhangxujie.konfig.model.AccountExample.Criteria;
import org.zhangxujie.konfig.model.AccountExample.Criterion;
...
public class AccountSqlProvider {
    ...
    public String countByExample(AccountExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("auth_account");
