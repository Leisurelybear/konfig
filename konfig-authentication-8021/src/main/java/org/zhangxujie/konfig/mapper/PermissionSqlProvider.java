...
import org.zhangxujie.konfig.model.PermissionExample.Criteria;
import org.zhangxujie.konfig.model.PermissionExample.Criterion;
...
public class PermissionSqlProvider {
    ...
    public String countByExample(PermissionExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("auth_permission");
    ...
    public String deleteByExample(PermissionExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("auth_permission");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(Permission record) {
        ...
        if (record.getIdentityType() != null) {
            sql.VALUES("identity_type", "#{identityType,jdbcType=VARCHAR}");
        }
        
        if (record.getIdentityId() != null) {
            sql.VALUES("identity_id", "#{identityId,jdbcType=INTEGER}");
        }
        ...
        if (record.getOperatorAccountId() != null) {
            sql.VALUES("operator_account_id", "#{operatorAccountId,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(PermissionExample example) {
        ...
        sql.SELECT("is_del");
        sql.SELECT("time");
        sql.SELECT("operator_account_id");
        sql.FROM("auth_permission");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getIdentityType() != null) {
            sql.SET("identity_type = #{record.identityType,jdbcType=VARCHAR}");
        }
        
        if (record.getIdentityId() != null) {
            sql.SET("identity_id = #{record.identityId,jdbcType=INTEGER}");
        }
        ...
        if (record.getTime() != null) {
            sql.SET("time = #{record.time,jdbcType=BIGINT}");
        }
        
        if (record.getOperatorAccountId() != null) {
            sql.SET("operator_account_id = #{record.operatorAccountId,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(Permission record) {
        ...
        if (record.getIdentityType() != null) {
            sql.SET("identity_type = #{identityType,jdbcType=VARCHAR}");
        }
        
        if (record.getIdentityId() != null) {
            sql.SET("identity_id = #{identityId,jdbcType=INTEGER}");
        }
        ...
        if (record.getOperatorAccountId() != null) {
            sql.SET("operator_account_id = #{operatorAccountId,jdbcType=INTEGER}");
        }
